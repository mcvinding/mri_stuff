...
cfg.channel             = 'MAG'; %% which channels to use
...
dip_mag_early_lin = ft_dipolefitting(cfg, data);
...
dip_mag_early_orig = ft_dipolefitting(cfg, data);
...
dip_mag_early_spm12 = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_lin.dim;
cfg.headmodel           = headmodel_lin; %% supply the headmodel
dip_mag_late_lin = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_orig.dim;
cfg.headmodel           = headmodel_orig; %% supply the headmodel
dip_mag_late_orig = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_spm12.dim;
cfg.headmodel           = headmodel_spm12; %% supply the headmodel
dip_mag_late_som12 = ft_dipolefitting(cfg, data);
...
cfg.model               = 'regional'; %% we assume that the dipole has a fixed position during the time points in the latency range
cfg.senstype            = 'MEG'; %% sensor type
cfg.channel             = 'GRAD'; %% which channels to use
cfg.nonlinear           = 'yes'; %% do a non-linear search
...
cfg.sourcemodel.dim     = sourcemodel_lin.dim;
cfg.headmodel           = headmodel_lin; %% supply the headmodel
dip_grad_early_lin = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_orig.dim;
cfg.headmodel           = headmodel_orig; %% supply the headmodel
dip_grad_early_orig = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_spm12.dim;
cfg.headmodel           = headmodel_spm12; %% supply the headmodel
dip_grad_early_spm12 = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_lin.dim;
cfg.headmodel           = headmodel_lin;
dip_grad_late_lin = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_lin.dim;
cfg.headmodel           = headmodel_orig; %% supply the headmodel
dip_grad_late_orig = ft_dipolefitting(cfg, data);
...
cfg.sourcemodel.dim     = sourcemodel_spm12.dim;
cfg.headmodel           = headmodel_spm12; %% supply the headmodel
dip_grad_late_spm12 = ft_dipolefitting(cfg, data);
